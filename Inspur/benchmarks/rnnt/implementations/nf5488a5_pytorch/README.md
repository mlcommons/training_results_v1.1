...
```
docker build --pull -t <docker/registry>/mlperf-inspur:rnn_speech_recognition-pytorch .
docker push <docker/registry>/mlperf-inspur:rnn_speech_recognition-pytorch
```
2. Launch the training:

```
source config_NF5****.sh
