...
## Run specific params
export DATADIR="/lvol/manju/mlperf/rnnt/"
export METADATA_DIR="/lvol/manju/mlperf/rnnt/LibriSpeech/tokenized/"
export SENTENCEPIECES_DIR="/lvol/manju/mlperf/rnnt/sentencepieces"
