...
## Run specific params
#xport DATADIR="/raid/datasets/rnnt/"
#xport METADATA_DIR="/lustre/fsw/mlperf-ci/tokenized/"
#xport SENTENCEPIECES_DIR="/lustre/fsw/mlperf-ci/sentpiece"
export DATADIR="/stor/mlperf/rnnt/data"
export METADATA_DIR="/stor/mlperf/rnnt/metadata"
export SENTENCEPIECES_DIR="/stor/mlperf/rnnt/sentencepieces"
export BATCHSIZE=512 #used to be 256
export EVAL_BATCHSIZE=676 #used to be 338
export GRAD_ACCUMULATION_STEPS=8 #used to be 1
WALLTIME_MINUTES=60
