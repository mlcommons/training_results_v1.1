...
_cont_mounts=("--volume=${DATADIR}:/workspace/ssd/data" "--volume=${LOGDIR}:/workspace/ssd/results" "--volume=${PRETRAINED_DIR}:/workspace/ssd")
...
nvidia-docker run --rm --init --detach \
    ...
    -v $PWD:/workspace/ssd -v /mnt/data3/work/coco:/workspace/ssd/data \
