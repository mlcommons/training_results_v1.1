...
#crashed..
#export BATCHSIZE=24
#export EXTRA_CONFIG='SOLVER.BASE_LR 0.24 SOLVER.WARMUP_FACTOR 0.000384 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (6000,8000) SOLVER.IMS_PER_BATCH 192 TEST.IMS_PER_BATCH 192 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 24000 MODEL.RPN.FPN_POST_NMS_TOP_N_PER_IMAGE False NHWC True MODEL.RESNETS.FIRST_TRANS_FUNC FastBottleneckWithFixedBatchNorm MODEL.RESNETS.TRANS_FUNC FastBottleneckWithFixedBatchNorm'
