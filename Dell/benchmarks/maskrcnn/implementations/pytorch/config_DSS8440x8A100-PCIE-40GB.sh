...
#export EXTRA_CONFIG='SOLVER.BASE_LR 0.15 SOLVER.WARMUP_FACTOR 0.00024 SOLVER.WARMUP_ITERS 625 SOLVER.WARMUP_METHOD mlperf_linear SOLVER.STEPS (9600,12800) SOLVER.IMS_PER_BATCH 120 TEST.IMS_PER_BATCH 120 MODEL.RPN.FPN_POST_NMS_TOP_N_TRAIN 12000 MODEL.RPN.FPN_POST_NMS_TOP_N_PER_IMAGE False NHWC True MODEL.RESNETS.FIRST_TRANS_FUNC FastBottleneckWithFixedBatchNorm MODEL.RESNETS.TRANS_FUNC FastBottleneckWithFixedBatchNorm'
