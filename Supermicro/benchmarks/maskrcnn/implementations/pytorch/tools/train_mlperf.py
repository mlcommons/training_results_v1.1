...
def check_completed_tags(iteration, world_size):
    ...
    if world_size > 1:
        ...
        ready_to_submit_evaluation_task = True if num_finished == world_size else False
    else:
...
def train(cfg, rank, world_size, distributed, random_number_generator=None, seed=None):
    ...
    if cfg.USE_CUDA_GRAPH:
        ...
        images_per_gpu_train = cfg.SOLVER.IMS_PER_BATCH // world_size
        images_per_gpu_test = cfg.TEST.IMS_PER_BATCH // world_size
