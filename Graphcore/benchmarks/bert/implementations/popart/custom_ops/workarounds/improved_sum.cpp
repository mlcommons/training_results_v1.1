...
/*
 * The DIFF https://phabricator.sourcevertex.net/D48165 caused long compile time on some other models, 
 * it is reverted. To work around it, this new custom op improved_sum has been added to copy the code 
 * of sumx.cpp in that diff. It can be removed when the long compile time issues is fixed.
 */
